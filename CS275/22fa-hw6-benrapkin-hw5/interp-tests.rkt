...
(define interp-tests
  ...
  (test-equal? "car" (eval-exp (app-exp (var-exp 'car) (list (lit-exp 5) (lit-exp 6))) init-env) 5)
  (test-equal? "cdr" (eval-exp (app-exp (var-exp 'cdr)  (list (lit-exp 5) (lit-exp 6)(lit-exp 7))) init-env) '(6 7))
  (test-exn "not prim"
          exn:fail?
...
;'(app-exp (var-exp '+) ((lit-exp 5) (lit-exp 6)))
;(app-exp (var-exp '+) (list (lit-exp 5) (lit-exp 6)))