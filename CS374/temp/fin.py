...
if __name__ == '__main__':
  ...
  #  print("train_x's shape: " + str(train_x.shape))
   # print("test_x's shape: " + str(test_x.shape))
    ...
    ann = ANN(layers_dims)
    ann.fit(X_training, Y_training, learning_rate=0.09, n_iterations=3000)
    ann.predict(X_training, Y_training)
    ann.predict(X_testing, Y_testing)
    ann.plot_cost()