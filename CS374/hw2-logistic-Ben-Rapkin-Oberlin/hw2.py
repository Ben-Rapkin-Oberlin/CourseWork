...
def train(trainData,validData):
    ...
    weights = [random.uniform(-.1,.1) for x in range(ncol)] #we use the full distance as 21 wi and one offest w0
    #print (len(weights))
    fail=0
    for i in range(500):
