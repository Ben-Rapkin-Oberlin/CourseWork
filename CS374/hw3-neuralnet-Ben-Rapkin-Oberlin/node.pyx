...
def train(numpy.ndarray[DTYPE_t, ndim=2] trainData, numpy.ndarray[DTYPE_t, ndim=2] validData ,numpy.ndarray[DTYPE_t, ndim=1] weights,learning_rate):
#def train(numpy.ndarray[DTYPE_t, ndim=2] trainData, numpy.ndarray[DTYPE_t, ndim=2] validData , weights,learning_rate,e):    
